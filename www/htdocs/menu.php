...
[<a href=\"UpdateNames.php?stopUpdate=1&service_port=".$service_port."&port_address=".$port_address."&netID=".$netID."&netName=".$netName."\">Update 1-Wire&reg; Chip Names</a>]&nbsp;&nbsp;

[<a href=\"updateDisplayNames.php?stopUpdate=1&service_port=".$service_port."&port_address=".$port_address."&netID=".$netID."&netName=".$netName."\">Update 1-Wire&reg; Display Names</a>]";
